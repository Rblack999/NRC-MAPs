...
@author: nrc-eme-lab
"""
from Connection import disconnect, connect
...
def pstat_run(campaign_name, input_procedure):
    ...
    address = "192.168.1.25"  # address of the device in use
    ...
    new_runs = "C:\\Users\\nrc-eme-lab\\Desktop\\Automation\\MultiChannel-Potentiostat-Management-Software\\Development_Test\\New_Runs\\"  # this is where the user
