...
# Numpy is optional and is only required if it is desired to get the data as
# numpy arrays
try:
    import numpy
    GOT_NUMPY = True
...
class GeneralPotentiostat(object):  # pylint: disable=too-many-public-methods
    ...
    def connect(self, timeout: object = 5) -> object:
...
class OCV(Technique):
    ...
    * Ece (float) (only wmp3 series hardware)
    ...
    def __init__(self, rest_time_T: object = 10.0, record_every_dE: object = 10.0,
                 record_every_dT: object = 0.1, E_range: object = 'KBIO_ERANGE_AUTO') -> object:
...
class CA(Technique):
    ...
    * cycle (int)
    ...
    def __init__(self, voltage_step: object = (0.35,), vs_initial: object = (False,),
                 duration_step: object = (10.0,),
                 record_every_dT: object = 0.1, record_every_dI: object = 5E-6,
                 N_cycles: object = 0, I_range: object = 'KBIO_IRANGE_AUTO',
                 E_range: object = 'KBIO_ERANGE_2_5', bandwidth: object = 'KBIO_BW_5') -> object:
...
class ECLibException(Exception):
    ...
    def __str__(self):
        return f'ECLib error (code: {self.error_code})'
